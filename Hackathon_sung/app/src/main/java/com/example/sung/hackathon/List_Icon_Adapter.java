...
public class List_Icon_Adapter extends ArrayAdapter implements View.OnClickListener  {
    ...
    List_Icon_Adapter(Context context, int resource, ArrayList<Integer> list) {
...
//        this.listBtnClickListener = clickListener ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final int listViewItem = (int) getItem(position);


        // 아이템 내 각 위젯에 데이터 반영
        iconImageView.setImageResource(listViewItem);
